...
public class AudioVideoRecorder {
    ...
    public static void main(String[] args) throws Exception, org.bytedeco.javacv.FrameGrabber.Exception {
        ...
        File f = new File("/Users/aleksandrkrasnov/Desktop/BoofCvRecord.flv");
        FFmpegFrameRecorder recorder = new FFmpegFrameRecorder(f, captureWidth, captureHeight, audioChannels);
        ...
        new Thread(() -> {
            ...
            AudioFormat audioFormat = new AudioFormat(44100.0F, 16, audioChannels, true, false);
