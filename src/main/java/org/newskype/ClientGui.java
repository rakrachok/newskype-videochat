...
public class ClientGui extends Thread{
  ...
  public class TextListener implements DocumentListener{
    ...
    TextListener(JTextField jtf1, JTextField jtf2, JTextField jtf3, JButton jcbtn){
      this.jtf1 = jtf1;
      this.jtf2 = jtf2;
      this.jtf3 = jtf3;
      this.jcbtn = jcbtn;
        ...
        try {
          ...
          if(message != null){
            if (message.charAt(0) == '[') {
              ...
              ArrayList<String> ListUser = new ArrayList<>(Arrays.asList(message.split(", ")));
              jtextListUsers.setText(null);
